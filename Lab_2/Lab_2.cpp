...
int main()
{
	...
	uint_least16_t size = 0, len; // len - длина знаков файла
	...
	do
	{
		...
		case '1':
			...
			while (true) ///// +++++++
			{
				...
				wr.write((char*)&size, sizeof(size));//////////// ++++++++
		...
		case '2':
			...
			do
			{
				...
				// Проверяем, что файл пуст - не содержит каких-либо символов
				if (rd.peek() == EOF)
				{
					rd.close();
					cout << "Файл пуст!" << endl;
